...
//    which is the likelihood of an application not working 
//    because of the introduction of updates (such as newer data types). 
//    Suppose that you upgrade your application and 
...
//    this approach is unnecessarily restrictive; what if you wanted to print members younger than a certain age,
//    for example?
...
//    or a combination of a specified gender and age range? 
//    What if you decide to change the Person class and add other attributes such as
//    relationship status or geographical location? 
//    Although this method is more generic than printPersonsOlderThan, 
//    trying to create a separate method for each possible search query can still lead to brittle code.
//    You can instead separate the code that specifies the criteria for which you want to 
//    search in a different class.
